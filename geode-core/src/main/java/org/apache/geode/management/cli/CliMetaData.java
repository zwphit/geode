...
public @interface CliMetaData {
   ...
   * When this is set to true, the RestHttpOperationInvoker will use an extractor to extract
   * the inputstream in the response to a temporary file and it's up to your command's interceptor's
