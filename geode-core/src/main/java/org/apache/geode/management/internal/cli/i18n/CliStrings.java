...
public class CliStrings {
  ...
  public static final String EXPORT_LOGS__DIR__HELP =
      "Local directory to which log files will be written. This is only used when you are exporting logs using http connection. If no specified, user.dir will be used.";
